  ...
  % ---
      ...
      \section{Modelagem e implementação de testes}
          ...
          \begin{figure}[htbp]
              \begin{center}
                  \includegraphics[width=0.85\textwidth]{img/afd.png}
              \end{center}
      ...
      \section{Técnicas de teste}
          ...
          \subsection{Técnica da caixa preta}
              ...
              entradas sejam testadas, melhor o teste é. Como já foi dito anteriormente que é
              impossível testar todas as entradas possíveis o programador pode utilizar classes
              de equivalência para maximizar os casos de teste coberto. As classes de equivalência
