  ...
  \part{Resultados obtidos}
    \chapter{Avaliação do framework}
      Para testar a capacidade do framework em gerar os testes, desenvolveu-se uma aplicação simples que simula a
      ...
      GitHub do autor. A tela de autenticação dessa aplicação pode ser visualizado na Figura 19.
      ...
      capuccino para o caso de se autenticar está disponível na Figura 20. Como pode ser observado, esse código
      ...
      \textit{/data/user/0/nome.da.aplicacao/files}.
      ...
      mesmo teste, um log acusando sucesso é exibida, como pode ser visto na Figura 21.
      ...
      as novas refatorações será gerado.
    ...
    \chapter{Conclusão}
      ...
      implementado cumpre com o que foi proposto. Foi desenvolvido uma ferramenta capaz de produzier testes, em nível de
      usuário, para dispositivos que utilizem como Sistema Operacional o Android. Além disso, o framework consegue
      diminuir significativamente o esforço investido durante a produção de testes, visto que não é necessário mais
      implementar testes a nível de código. Basta que o testador, ou um usuário real, utilizem a aplicação alvo usando
      como guia algum caso de uso que ao final da execução terão disponível um teste em nível de usuário. Consequentemente,
      acaba não sendo mais necessário que os membros da equipe de teste de um projeto aprendam a usar uma biblioteca de teste.
