  ...
  \begin{resumo}
    ...
    o esforço e tempo investidos durante a fase de desenvolvimento testes automatizados,
  ...
  \chapter{Trabalhos relacionados}
    Nesse capítulo será apresentado trabalhos relacionados que envolvam tanto o desenvolvimento de frameworks
    bem como ferramentas que ajudem na elaboração automática de testes automatizados. Os trabalhos aresentados
    ...
    \section{A busca de generalidade, flexibilidade e extensibilidade noprocesso de desenvolvimento de frameworks orientados a objetos}
    Nesse artigo é feito uma abordagem, resumida, dos principais conceitos envolvendo frameworks, a
    ...
    \section{An Object-Oriented Framework for Improving Software Reuse on Automated Testing of Mobile Phones}
      ...
      mobile é um conceito que já foi aplicado no passado, como pode ser observado nesse artigo. Esse trabalho
      possui como principal foco o desenvolvimento de destes automatizados baseado em casos de uso, usando
      o reuso como principal forma de alcançar esse objetivo. No framework desenvolvido, ainda era necessário
      que o programador implementasse manualmente os testes. Porém, a grande vantagem do uso desse framework
      era que ele possuia grandes abstrações de hardware e se comunicava com o baixo nível através da API
      da Motorola, uma espécie de \textit{syscall}. A grande vantagem, era que o porte (i.e. executar
      os testes de um dispositivo em outro) podia ser feito sem necessidade de alterar o teste.

      O framework desenvolvido tinha duas classes abstrata: \textit{Step} e \textit{BaseTestCase}. A
      ...
      alcançado pelo TAF através de três mecanismos: herança, reuso de funções úteis e porte de casos
      de teste automatizados já existentes.
    ...
    \section{Trabalho zica}

  \part{Conteúdo produzido e metas para TCC II}
  ...
  \chapter{Conteúdo produzido}
    ...
    Durante o desenvolvimento dessa aplicação, também foi criado uma bateria de testes com o objetivo, além
    de garantir a qualidade do aplicativo, estudá-los e refletir sobre uma maneira de estudá-los.
    ...
    testarem as rotas da aplicação, testavam se o resultado retornado pelo \textit{backend} era o esperado.
    Nesse sentido, busca-se estudar esses testes e buscar uma forma de generalizá-los a ponto de serem
    capazes de ser gerados automaticamente por uma ferramenta automatizada.
  ...
  \chapter{Metas para TCC II}
    Para a disciplina INE 5434 Trabalho de Conclusão de Curso II, possui como meta fazer a modelagem e
    implementação do framework que irá auxiliar na elaboração automatizada de testes automaziados. Além
    disso, será feito um estudo de resultados verificando o quanto o framework ajudou, em termos percentuais,
    na implementação de testes automatizados. Por último, esse processo será relatado textualmente nesse
    trabalho juntamente com a conclusão e sugestão de trabalhos futuros.
