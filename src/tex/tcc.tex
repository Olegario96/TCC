  ...
  % ---
      ...
      e o time de qualidade estejam constantemente revisando o código produzidos por
      ...
      qunado alguém que não desenvolveu o componente começa a se iterar mais com o código
      ...
      o erro. Por isso, os cenários de teste devem ser sempre atualizados e revisados.
      ...
      contemplados, uma que fogem muito do escopo do que o trabalho se propõe a fazer.
      ...
      \section{Modelagem e implementação de testes}
          ...
          Na modelagem de testes é importante também que durante a implementação existam
          ...
          da computação, o mais comum é enxergar o teste do módulo como sendo uma \textbf{
          ...
          o máximo de qualidade possível ele teria que testar todos os caminhos possíveis
          partido do estado inicial. Nesse exemplo, a tarefa de testar o módulo é perfeitamente
          realizável, uma vez que existem poucas transições. Porém, pensando em casos mais
          reais em que as classes possuem pelo menos de 6 a 8 métodos e que podem ter
          suas próprias execeções, a tarefa de testar completamente um módulo começa a ficar
          ...
          mais transições dos estados mais a direita em direção a outros estados por uma mera
          questão de legibilidade. Entretanto, dentro de um contexto de um objeto que é utilizado
          várias vezes, a chamada reptitiva de vários métodos sucessivamente pode acarretar,
          ...
          \textit{factory} costuma ser muito comum, já que é uma solução necessária e elegante
          ...
          que se esse padrão não fosse utilizado, para cada teste o prgramador teria que sempre
      ...
      \section{Níveis de teste}
          ...
          usuário. Classicamente, os testes, quando dividos dessa forma, podem pertencer
          alguma dessas classes: unidade, integração, sistema, aceitação e o de regressão.
          Nas próximas subsecções seram apresentados previamente cada uma dessas classificações.
          ...
          \subsection{Teste de unidade}
              ...
              os mais baratos de serem desenvolvidos e os mais rápidos de serem executados (FLOW, 2012).
              Esse fato é também conhecido como \textit{pirâmide de testes}.
              É importante também, que este nível de teste visa somente fazer o teste de uma classe
              isolada. Caso a classe que está sendo testada iteraja de alguma forma com outras classes
              , seja por atributos ou parâmetros de funções, o programador, deve, então, usar
              objetos falsos, também conhecidos como \textit{mock}, para simular a classe que possui
              relação com a classe que está sendo testada. Essa metodologia garante que caso qualquer defeito detectado pelo teste, o defeito vem única e exclusivamente da classe que está sendo testada, e não de classes terceiras.
          ...
          \subsection{Teste de integração}
              ...
              que trabalham em conjunto. Nesse nível deve-se testar todas as classes que possuêm
              alguma relação do tipo: associação, composição ou agregação. Ao em vez de usar objetos
              falsos, como era feito no nível anterior, deve-se objetos verdadeiros e testar os
              métodos os quais estes objetos trocam mensagens. Em casos em que um dos módulos
              ...
              de teste não deve cubrir integrações com interfaces ou integração com sisteamas de
      ...
      \section{Técnicas de teste}
          ...
          Todas elas possuêm em comum em encontrar falhas no componente desenvolvido. As principais
          ...
          \subsection{Técnica da caixa branca}
              ...
              caixa preta. A ideia consiste em testar qual fluxo o código está sendo executado na no componente. Esse tipo de teste visa eliminiar trechos que nunca
              são alcançados dentro de um método ou que sejam reduntantes. Quando esta técnica é aplicada
              todas as possibilidades de fluxo um método devem ser testados (i.e. \textit{while, for,
              ...
              modelagem de testes baseado em autômatos. Conforme Wazlawick (2012, p. 400) é apresentado uma
              ...
              Através da gravura, é percebido que, então, o princípio do teste é passar por todas as arestas do
              automâto e caso alguma aresta em nenhuma hipótese seja utilizada é porque a estrutura jamais
              é alcançada ou possui uma condição impossível de ser atendida. Um exemplo claro disso seria algo
              como \textit{if (age < 0)}. Isso jamais vai ocorrer se a variável que carrega a idade possui
              a pré condição de sempre ser positiva.

              \begin{figure}[htbp]
                  \begin{center}
                      \includegraphics[width=0.15\textwidth]{img/whitebox.png}
                  \end{center}
