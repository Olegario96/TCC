  ...
  % ---
      ...
      \section{Desenvolvimento de aplicações mobile Android}
        ...
        muito antiga, pensando em atender 100\% do mercado ele ficar sem muitas facilidades e
        ...
        recebido, ou simplesmente nenhuma, podendo alterar a decisão mais tarde. Após feito essa
        ...
        para o template escolhido. O arquivo XML serve unica e exclusivamente para definir como cada
        ...
        do modelo. Cada \textit{activity} tem sua própria controlora e não deve gerenciar mais nenhuma
        outra interface, além da que foi designada.Outro ponto importante, é que alguns métodos
        herdados da classe \textit{Activity} tratam de ventos importantes como: atividade inicializada,
        ...
        desenvolvedor pode fazer testar o software sem precisar baixar em um aparelho
        ...
        é importante que quem esteja testando a aplicação faz os testes finais em
