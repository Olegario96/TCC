  ...
  % ---
      ...
      Nesse sentido, nas próximas secções será apresentada um pouco de como funciona o
      desenvolvimento de um aplicativo mobile em uma visão mais alto nível, em seguida
      uma breve abordagem técnica e histórica do Android e por último uma visão
      mais próxima do código e de como funciona uma aplicação real dentro dessa plataforma.
