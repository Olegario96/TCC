  ...
  \begin{resumo}
    ...
    o esforço e tempo investidos durante a fase de elaboração testes automatizados.
  ...
  técnicas de testes de software e quais as ferramentas disponíveis atualmente
  no mercado. Na sequência será abordado alguns aspectos no que se refere a
  ...
  \chapter{Frameworks}
      ...
      \section{Origem dos Frameworks}
          ...
          framework pode ser observada na próxima figura.
      ...
      \section{Princípios de frameworks}
          ...
          relacionados ao framework. Na figura seguinte, é possível observar alguns
          métodos, dentro do framework FraG, que são classificados como template ou hook.
  ...
  % ---
      ...
      a sigla em inglês é TDD. O diagrama seguinte ilustra bem esse
      ...
      \section{Técnicas de teste}
          ...
          \subsection{Técnica da caixa preta}
              ...
              operador de diferença, basta utilizar o operado de >. Para os demais valores, basta criar
          ...
          \subsection{Técnica da caixa branca}
              ...
              componente. Esse tipo de teste visa eliminiar trechos que nunca são alcançados dentro de
              um método ou que sejam reduntantes. Quando esta técnica é aplicada todas as possibilidades
              de fluxo um método devem ser testados (i.e. \textit{while, for, if, else, try, catch,
              finally}).
              ...
              apresentada uma forma de modelar testes, baseados nessa técnica, muito interessante. A
              ideia consiste em modelar um autômato finito em que que cada nodo representa uma linha ou
              um conjunto de linhas sequenciais que contenham no máximo uma estrutura de controle e as
              arestas representam o atendimento ou não da condição imposta pela estrutura. A modelagem
  ...
  % ---
      ...
      primeiros dispositivos móveis, mas que ganhou mais destaque nos últimos anos, como visto no
      gráfico seguinte. Nas primeiras gerações de celulares com interface gráficas e com capacidade
      ...
      maneira que fosse simples para um usuário mais leigo. Geralmente o processo envolvia baixar
      ...
      dispositivos móveis, como pode ser observado na Figura 12. São esses: Android, iOS e Microsoft Phone, produzidos respectivamente pela
