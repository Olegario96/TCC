    ...
    \chapter{Análise e desenvolvimento do framework}
      ...
      \section{Concepção}
        ...
        \section{Modelagem e Implementação}
          ...
          Ao final desse processo, o usuário terá criado um único caso de teste descrito em um arquivo. Esse
          teste, ao ser exportado para o diretório de testes de aplicação, pode ser executado normalmente. Durante
          a execução do teste criado, o teste irá iniciar a aplicação no dispositivo previamente emulado e
          irá executar as mesmas ações que o usuário executou, na mesma ordem de forma automática. Após performar
          a última ação, a asserção definida pelo usuário será executada e seu retorno será exibida no \textit{Logger}
          do Android Studio.
  ...
  \part{Resultados obtidos}
    \chapter{Resultados obtidos}
      ...
      GitHub do autor. A tela de autenticação dessa aplicação pode ser visualizado na Figura 18.
      ...
      capuccino para o caso de se autenticar está disponível na Figura 19. Como pode ser observado, esse código
      ...
      mesmo teste, um log acusando sucesso é exibida, como pode ser visto na Figura 20.
