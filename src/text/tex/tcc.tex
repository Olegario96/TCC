  ...
  \begin{resumo}[Abstract]
   \begin{otherlanguage*}{english}
     ...
     tests allowing the developers to focus on tasks that demand
        ...
        \begin{figure}[htbp]
          \begin{center}
            \includegraphics[width=1.0\textwidth]{img/capuccinoActivity.png}
              \end{center}
            \caption{\label{fig:passaro} Diagrama de atividades para o caso de uso de gerar um caso de teste.}
          \begin{center}(FONTE: Imagem feita pelo autor)\end{center}
        \end{figure}
      ...
      \begin{figure}[htbp]
        \begin{center}
          \includegraphics[width=1.0\textwidth]{img/capuccinoAutomatedTest.png}
            \end{center}
          \caption{\label{fig:passaro} Caso de teste gerado pelo \textit{capuccino}.}
        \begin{center}(FONTE: Imagem feita pelo autor)\end{center}
      \end{figure}
